package com.txstate.actual.network.neural;
...
public class Backpropagation {
    ...
    public void train(DataGenerator generator, double errorThreshold) {
        ...
        do {
            DataTrain trainingData = generator.getTrainingData();
