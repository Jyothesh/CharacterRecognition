package com.txstate.actual.network.service;
...
public class LoadImageService {
    ...
    public LoadImageService(String labelFileName, String imageFileName) {
        this.labelFileName = labelFileName;
        this.imageFileName = imageFileName;
    }

    public List<DataImage> loadDigitImages() throws IOException {
        List<DataImage> images = new ArrayList<DataImage>();
        ...
        for(int i = 0; i < numberOfLabels; i++) {
            ...
            images.add(new DataImage(label, imageData));
        }
